    ...
    chapters: [
        {
            id: 'chapter-1',
            title: {
                fr: "Le Berceau Oublié",
                en: "The Forgotten Cradle",
                ar: "المهد المنسي"
            },
            summary: {
                fr: "Introduction à Elara, une jeune orpheline vivant dans un village reculé, hantée par des rêves étranges et le mystère de ses origines.",
                en: "Introduction to Elara, a young orphan living in a remote village, haunted by strange dreams and the mystery of her origins.",
                ar: "مقدمة إلى إيلارا، يتيمة شابة تعيش في قرية نائية، تطاردها أحلام غريبة وغموض أصولها."
            },
            text: {
                fr: `
        ...
        },
        {
            id: 'chapter-2',
            title: {
                fr: "L'Appel du Destin",
                en: "The Call of Destiny",
                ar: "نداء القدر"
            },
            summary: {
                fr: "Elara quitte son village pour un voyage inattendu, guidée par le médaillon et un vieux parchemin trouvé dans les affaires de Thera.",
                en: "Elara leaves her village for an unexpected journey, guided by the locket and an old parchment found among Thera's belongings.",
                ar: "إيلارا تغادر قريتها في رحلة غير متوقعة، تسترشد بالقلادة ولفافة قديمة عثر عليها ضمن ممتلكات ثيرا."
            },
            text: {
                fr: `
        ...
        // Ajoutez 42 autres chapitres ici en suivant la même structure
        // Exemple pour Chapitre 3:
        {
            id: 'chapter-3',
            title: {
                fr: "Les Sentiers Oubliés",
                en: "The Forgotten Paths",
                ar: "المسالك المنسية"
            },
            summary: {
                fr: "Elara rencontre son premier défi sur la route, une forêt enchantée qui teste sa volonté et ses capacités naissantes.",
                en: "Elara faces her first challenge on the road, an enchanted forest that tests her will and budding abilities.",
                ar: "إيلارا تواجه تحديها الأول على الطريق، غابة مسحورة تختبر إرادتها وقدراتها الناشئة."
            },
            text: {
                fr: `
        ...
        // ... (Insérez 41 autres chapitres avec contenu unique ici)
        // Je vais ajouter un exemple de chapitre 44 pour montrer la fin.
        {
            id: 'chapter-44',
            title: {
                fr: "L'Aube Nouvelle",
            ...
            summary: {
                fr: "Elara, ayant accompli sa destinée, assiste à l'aube d'une nouvelle ère de paix et de lumière, sachant que son voyage n'est qu'un début.",
                en: "Elara, having fulfilled her destiny, witnesses the dawn of a new era of peace and light, knowing her journey is just beginning.",
                ar: "إيلارا، بعد أن أتمت قدرها، تشهد بزوغ فجر جديد من السلام والنور، مع علمها بأن رحلتها ليست سوى البداية."
            },
            text: {
                fr: `
        ...
        // ... (Assurez-vous d'avoir un total de 44 chapitres)
    ]
};

// Vérifier et ajouter les chapitres restants si nécessaire
const numChaptersNeeded = 44 - content.chapters.length;
if (numChaptersNeeded > 0) {
    for (let i = 0; i < numChaptersNeeded; i++) {
        const chapterNumber = content.chapters.length + 1;
        content.chapters.push({
            id: `chapter-${chapterNumber}`,
            title: {
                fr: `Chapitre ${chapterNumber}: Le Secret Révélé ${chapterNumber}`,
                en: `Chapter ${chapterNumber}: The Secret Revealed ${chapterNumber}`,
                ar: `الفصل ${chapterNumber}: السر المكشوف ${chapterNumber}`
            },
            summary: {
                fr: `Un aperçu du chapitre ${chapterNumber}, explorant de nouvelles révélations et défis pour Elara.`,
                en: `An overview of chapter ${chapterNumber}, exploring new revelations and challenges for Elara.`,
                ar: `نظرة عامة على الفصل ${chapterNumber}، استكشاف كشوف وتحديات جديدة لإيلارا.`
            },
            text: {
                fr: `
                    <p>Le chemin d'Elara l'a menée à des rencontres inattendues et des découvertes profondes. Chaque pas est un apprentissage, chaque obstacle une leçon. Dans ce chapitre, le voile se lève un peu plus sur les mystères de son passé et les forces qui guident son destin.</p>
                    <p>Les anciennes légendes murmurent des vérités oubliées, et Elara se retrouve au cœur d'une intrigue qui dépasse l'entendement. Des choix difficiles l'attendent, des sacrifices seront peut-être nécessaires, mais sa détermination reste inébranlable. La lumière qu'elle porte devient de plus en plus brillante, attirant à la fois amis et ennemis.</p>
                    <p>Elle apprend à maîtriser davantage ses pouvoirs, à écouter la voix de son intuition et à faire confiance aux liens qui se sont tissés autour d'elle. Le destin du monde repose sur ses épaules, et elle est prête à l'affronter, quel qu'en soit le prix. Le secret révélé dans ce chapitre changera à jamais sa perception de la réalité et de sa place dans ce vaste univers.</p>
                `,
                en: `
                    <p>Elara's journey has led her to unexpected encounters and profound discoveries. Every step is a learning experience, every obstacle a lesson. In this chapter, the veil lifts a little more on the mysteries of her past and the forces guiding her destiny.</p>
                    <p>Ancient legends whisper forgotten truths, and Elara finds herself at the heart of a plot that defies understanding. Difficult choices await her, sacrifices may be necessary, but her determination remains unshaken. The light she carries grows brighter and brighter, attracting both friends and foes.</p>
                    <p>She learns to further master her powers, to listen to the voice of her intuition, and to trust the bonds that have formed around her. The fate of the world rests on her shoulders, and she is ready to face it, whatever the cost. The secret revealed in this chapter will forever change her perception of reality and her place in this vast universe.</p>
                `,
                ar: `
                    <p>قادت رحلة إيلارا إلى لقاءات غير متوقعة واكتشافات عميقة. كل خطوة هي تجربة تعليمية، وكل عقبة هي درس. في هذا الفصل، يرتفع الستار أكثر قليلاً عن أسرار ماضيها والقوى التي توجه مصيرها.</p>
                    <p>تتحدث الأساطير القديمة عن حقائق منسية، وتجد إيلارا نفسها في قلب مؤامرة تتجاوز الفهم. تنتظرها خيارات صعبة، وقد تكون التضحيات ضرورية، لكن تصميمها يظل ثابتًا. يزداد النور الذي تحمله إشراقًا، يجذب الأصدقاء والأعداء على حد سواء.</p>
                    <p>تتعلم إتقان قواها بشكل أكبر، والاستماع إلى صوت حدسها، والثقة بالروابط التي تشكلت حولها. مصير العالم يقع على عاتقها، وهي مستعدة لمواجهته، مهما كان الثمن. السر الذي كُشف في هذا الفصل سيغير إلى الأبد تصورها للواقع ومكانتها في هذا الكون الواسع.</p>
                `
            }
        });
    }
